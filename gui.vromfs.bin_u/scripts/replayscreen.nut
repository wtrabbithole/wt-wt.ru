...
class ::gui_handlers.ReplayScreen extends ::gui_handlers.BaseGuiHandlerWT
{
  ...
  statsColumnsOrderPvp  = [ "team", "name", "score", "kills", "groundKills", "navalKills", "assists",
...
/*      local limits = ""
  ...
  function gatherReplayCommentData(replayInfo, gameType)
  {
    ...
    local missionObjectivesMask = ::g_mission_type.getTypeByMissionName(missionName).objectives
    local rowHeader = []
    local headerArray = []
    foreach(id in columnsOrder)
    {
