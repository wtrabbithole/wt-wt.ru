...
/*
  "12345" = {  //uid
    ...
    uid = "12345"
    presence = ""
    presenceIcon = "player_ready"
    presenceText = "Player ready!"
  }
*/
::contacts <- null
/*
...
function sortContacts(a, b)
{
  ...
  local nameA = ::english_russian_to_lower_case(a.name)
  local nameB = ::english_russian_to_lower_case(b.name)
...
class ::ContactsHandler extends ::gui_handlers.BaseGuiHandlerWT
{
  ...
  function updatePlayersList(gName)
  {
    ...
    foreach(fIdx, f in ::contacts[gName])
    {
      ...
      imgObj["background-image"] = f.presenceIcon? "#ui/gameuiskin#" + f.presenceIcon : ""
  ...
  function showCurPlayerRClickMenu(position = null)
  {
    ...
    local menu = [
      ...
      }
      {
        ...
        action = (@(inviteMenu) function() { openInviteMenu(inviteMenu) })(inviteMenu)
      }
    ]
...
function editContactMsgBox(player, groupName, add, ownerHandler, onModify = null) //playerConfig: { uid, name }
{
  ...
  if (add)
  {
    ...
    if (res)
    {
      ...
      ::scene_msg_box("added_to_list", null, format(msg, contact.name), [["ok", function() {} ]], "ok")
    }
  }
  else
  {
...
class Contact
{
  ...
  constructor(contactData)
  {
    ...
    presenceIcon = presence.presenceIcon
    unknown = true
...
function updateContact(config)
{
  ...
  contact.presenceIcon = presence.presenceIcon
...
function fillContactTooltip(obj, contact, handler)
{
  local view = {
    ...
    presenceIcon = contact.presenceIcon ? "#ui/gameuiskin#" + contact.presenceIcon : ""
