...
function g_unlocks::loadFavorites()
{
  ...
  local loaded = ::load_local_custom_settings(FAVORITE_UNLOCKS_LIST_SAVE_ID)
  if(loaded)
  {
...
function g_unlocks::saveFavorites()
{
  ...
  ::save_local_custom_settings(FAVORITE_UNLOCKS_LIST_SAVE_ID, saveBlk)
}
