...
class ::gui_handlers.InfoWnd extends ::BaseGuiHandler
{
  ...
  {
    return !_checkId || ::load_local_custom_settings(INFO_WND_SAVE_PATH + "/" + _checkId, true)
  }

  static function setCanShowAgain(_checkId, canShowAgain)
  {
    ::save_local_custom_settings(INFO_WND_SAVE_PATH + "/" + _checkId, canShowAgain)
  }

  static function clearAllSaves()
  {
    ::save_local_custom_settings(INFO_WND_SAVE_PATH, null)
  }
