...
class ::gui_handlers.ShopMenuHandler extends ::gui_handlers.GenericOptions
{
  ...
  shopData = null
  slotbarActions = [ "research", "buy", "take", "showroom", "rankinfo", "testflight", "weapons", "crew", "info", "repair" ]
  actionsPrefix = "on"
...
*/
  ...
  function initShowMode(tgtNavBar)
  {
    ...
    local showModeRaw = ::load_local_custom_settings("shopShowMode", -1)
  ...
  function onChangeShowMode(obj)
  {
    ...
    ::save_local_custom_settings("shopShowMode", curDiffCode)
