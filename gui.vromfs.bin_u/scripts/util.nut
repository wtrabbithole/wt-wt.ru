...
function set_shop_new_items_icon_visible(value, scene = null)
{
  local iconObj = ::get_object_from_scene("items_shop_new_items_icon", scene)
  if (iconObj != null)
    iconObj.show(value)
}

function set_inventory_icon_visible(value, scene = null)
{
  local iconObj = ::get_object_from_scene("gc_inventory", scene)
  if (iconObj != null)
    iconObj.show(value)
}

function set_inventory_new_items_icon_visible(value, scene = null)
{
  local invIcon = ::get_object_from_scene("gc_inventory_new_items_icon", scene)
  if (invIcon != null)
    invIcon.show(value)
}
...
function save_local_custom_settings(path, value, forceSave = false)
{
...
function load_local_custom_settings(path, defValue = null)
{
  local cdb = ::get_local_custom_settings_blk()
...
// Deprecated, for storing new data use load_local_custom_settings() instead.
...
// Deprecated, for storing new data use save_local_custom_settings() instead.
...
function statsd_on_login()
{
  if (::is_platform_windows)
  {
    statsd_counter("login")
    ...
    local preset = ::get_controls_preset();
    if (preset == "")
    {
