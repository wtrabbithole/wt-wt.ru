...
class ::gui_handlers.EventsHandler extends ::gui_handlers.BaseGuiHandlerWT
{
  ...
  function checkAskOpenRoomsList()
  {
    ...
    if (maxCount < ::load_local_custom_settings(ROOMS_LIST_OPEN_COUNT_SAVE_ID, 0))
    {
  ...
  function onRoomsList()
  {
    ...
    canAskAboutRoomsList = false
    ::save_local_custom_settings(ROOMS_LIST_OPEN_COUNT_SAVE_ID,
      ::load_local_custom_settings(ROOMS_LIST_OPEN_COUNT_SAVE_ID, 0) + 1)
  }
