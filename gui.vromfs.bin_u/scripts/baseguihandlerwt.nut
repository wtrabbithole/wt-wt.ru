...
class ::gui_handlers.BaseGuiHandlerWT extends ::BaseGuiHandler
{
  ...
  function fillGamercard()
  {
    ...
    if (("getWndHelpConfig" in this) && getWndHelpConfig)
      showSceneBtn("gc_wnd_help", true)
  }
  ...
  function onWndHelp()
  {
    ...
    local config = getWndHelpConfig()
    if (config)
      ::gui_handlers.HelpInfoHandlerModal.open(config, scene)
  }
