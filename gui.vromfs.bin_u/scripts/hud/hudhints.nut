...
function g_hud_hints::_buildMarkup(eventData)
{
  return ::g_hints.buildHintMarkup(buildText(eventData), getHintMarkupParams(eventData))
}

function g_hud_hints::_getHintMarkupParams(eventData)
{
  return {
    id = name
    style = getHintStyle()
...
::g_hud_hints.template <- {
  ...
  {
    return ::milliseconds_to_seconds(::dagor.getCurTime() - hintAddTime)
  }
...
::g_enum_utils.addTypesByGlobalName("g_hud_hints", {
  ...
  MISSION_HINT = {
    hintType = ::g_hud_hint_types.MISSION
    ...
    getHintMarkupParams = function(eventData)
    {
      local res = ::g_hud_hints._getHintMarkupParams.call(this, eventData)
    ...
    getTimerTotalTimeSec = function(eventData)
    {
      if (_missionTimerTotalMsec <= 0
        ...
        return 0
      return ::milliseconds_to_seconds(_missionTimerTotalMsec)
    }
    getTimerCurrentTimeSec = function(eventData, hintAddTime)
    {
      return ::milliseconds_to_seconds(::dagor.getCurTime() - _missionTimerStartMsec)
    }
  }
