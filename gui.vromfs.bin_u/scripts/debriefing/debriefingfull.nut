...
::debriefing_rows <- [
  { id = "AirKills"
    ...
    {
      return ::g_mission_type.getCurrent().objectives & MISSION_OBJECTIVE.KILLS_AIR
    }
  }
  { id = "GroundKills"
    showByTypes = function(gt) {return (!(gt & ::GT_RACE))}
    ...
    isVisibleWhenEmpty = function()
    {
      return ::g_mission_type.getCurrent().objectives & MISSION_OBJECTIVE.KILLS_GROUND
    }
  }
  { id = "NavalKills"
    showByTypes = function(gt) {return (!(gt & ::GT_RACE))}
    ...
    isVisibleWhenEmpty = function()
    {
      return ::g_mission_type.getCurrent().objectives & MISSION_OBJECTIVE.KILLS_NAVAL
    }
  }
  "GroundKillsF",
  "NavalKillsF",
