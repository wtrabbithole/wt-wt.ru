...
function g_tasker::addTask(taskId, taskOptions = null, onSuccess = null, onError = null, taskCbType = TASK_CB_TYPE.BASIC)
{
  if (taskId < 0)
    return false
...
function g_tasker::charSimpleAction(requestName, requestBlk = null, taskOptions = null, onSuccess = null, onError = null)
{
...
function g_tasker::charRequestJson(requestName, requestBlk = null, taskOptions = null, onSuccess = null, onError = null)
{
...
function g_tasker::charRequestBlk(requestName, requestBlk = null, taskOptions = null, onSuccess = null, onError = null)
{
...
function g_tasker::addTaskData(taskId, taskCbType, onSuccess, onError, showProgressBox, showErrorMessageBox)
{
  local taskData = {
    taskId = taskId
...
function g_tasker::restoreCharCallback()
{
  ::set_char_cb(::g_tasker, ::g_tasker.charCallback)
}

function g_tasker::charCallback(taskId, taskType, taskResult, taskCbType = TASK_CB_TYPE.BASIC, data = null)
{
  executeTaskCb(taskId, taskResult)
}

function g_tasker::onCharRequestJsonFromServerComplete(taskId, requestName, data, result)
{
  executeTaskCb(taskId, result, TASK_CB_TYPE.REQUEST_DATA, data)
}

function g_tasker::onCharRequestBlkFromServerComplete(taskId, requestName, blk, result)
{
  executeTaskCb(taskId, result, TASK_CB_TYPE.REQUEST_DATA, blk)
}

function g_tasker::executeTaskCb(taskId, taskResult, taskCbType = TASK_CB_TYPE.BASIC, data = null)
{
...
function g_tasker::isMsgBoxesAvailable()
{
  return "scene_msg_box" in ::getroottable()
}

function g_tasker::showTaskProgressBox(text = null, cancelFunc = null, delayedButtons = -1)
{
...
function g_tasker::hideTaskProgressBox()
{
  if (!isMsgBoxesAvailable() || !::checkObj(currentProgressBox))
    return
...
function g_tasker::getNumBlockingTasks()
{
  local result = 0
...
function g_tasker::onEventScriptsReloaded(p)
{
  restoreCharCallback()
}

function g_tasker::onEventLoginStateChanged(p)
{
  restoreCharCallback()
}
